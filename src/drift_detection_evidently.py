...
from evidently.legacy.metric_preset import DataDriftPreset, TargetDriftPreset, RegressionPreset
...
def run_evidently_drift_report(reference_df: pd.DataFrame,
    ...
    The report covers:
      ...
      • TargetDriftPreset — distribution shift in the target variable (total_fare_amount)
